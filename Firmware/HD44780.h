...
//----- Auxiliary data ---------------------------//
#define __LCD_Pulse_us					2			// ORIG = 1 
#define __LCD_Delay_1					40			// ORIG = 20 
#define __LCD_Delay_2					20			// ORIG = 10 
#define __LCD_Delay_3					2			// ORIG = 1 
#define __LCD_Delay_4					2			// ORIG = 1 
...
void LCD_PrintInteger2(int32_t Value, uint8_t sizeMax);
